...
#if !defined(AFX_COMMANDS_H__A8D32148_E3F9_4DF0_AF71_9A282653DAC2__INCLUDED_)
#define AFX_COMMANDS_H__A8D32148_E3F9_4DF0_AF71_9A282653DAC2__INCLUDED_

#include "DefineAddinTypes.h"

class CCommands : 
	public CComDualImpl<ICommands, &IID_ICommands, &LIBID_DefineAddin>, 
...
protected:
	...
	class XApplicationEvents : public XEventHandler<IApplicationEvents, 
		&IID_IApplicationEvents, &LIBID_DefineAddin, 
	...
	class XDebuggerEvents : public XEventHandler<IDebuggerEvents, 
		&IID_IDebuggerEvents, &LIBID_DefineAddin, 
...
public:
// ICommands methods
	STDMETHOD(DefineAddinCommandMethod)(THIS);
};
...
#endif // !defined(AFX_COMMANDS_H__A8D32148_E3F9_4DF0_AF71_9A282653DAC2__INCLUDED)
