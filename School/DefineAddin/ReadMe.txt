========================================================================
       DEVELOPER STUDIO ADD-IN : DefineAddin
========================================================================


The Add-in Wizard has created this DefineAddin DLL for you.  This DLL not only
...
make up your DefineAddin DLL.


DefineAddin.h
	This is the main header file for the DLL.  It declares the
	CDefineAddinApp class.

DefineAddin.cpp
	This is the main DLL source file.  It contains the class CDefineAddinApp.
...
Commands.cpp, Commands.h
    ...
    a sample command (DefineAddinCommand) which displays a message
...
StdAfx.h, StdAfx.cpp
    ...
    named DefineAddin.pch and a precompiled types file named StdAfx.obj.
