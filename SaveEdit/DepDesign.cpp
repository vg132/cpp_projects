// DepDesign.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CDepDesign, CFormView)

CDepDesign::CDepDesign()
	: CFormView(CDepDesign::IDD)
{
	//{{AFX_DATA_INIT(CDepDesign)
	m_Stars_Average = 0;
	m_Stars_Excellent = 0;
	m_Stars_Good = 0;
	m_Stars_Trainee = 0;
...
void CDepDesign::DoDataExchange(CDataExchange* pDX)
{
	CFormView::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDepDesign)
...
BEGIN_MESSAGE_MAP(CDepDesign, CFormView)
	//{{AFX_MSG_MAP(CDepDesign)
		// NOTE - the ClassWizard will add and remove mapping macros here.
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CDepDesign diagnostics

#ifdef _DEBUG
void CDepDesign::AssertValid() const
{
	CFormView::AssertValid();
}

void CDepDesign::Dump(CDumpContext& dc) const
{
	CFormView::Dump(dc);
}
#endif //_DEBUG
...
/////////////////////////////////////////////////////////////////////////////
// CDepDesign message handlers

void CDepDesign::OnInitialUpdate() 
{
...
void CDepDesign::Load(int id, CString file)
{
CFile f;
	...
	f.Seek(9544+(id*7824),CFile::begin);
...
void CDepDesign::Save(CString file)
{
CFile f;
	...
	f.Seek(9544+(m_Id*7824),CFile::begin);
