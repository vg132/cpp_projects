#if !defined(AFX_DEPDESIGN_H__66D61723_6E51_11D4_8FC7_0008C7636E27__INCLUDED_)
#define AFX_DEPDESIGN_H__66D61723_6E51_11D4_8FC7_0008C7636E27__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// DepDesign.h : header file
//

/////////////////////////////////////////////////////////////////////////////
// CDepDesign form view

#ifndef __AFXEXT_H__
#include <afxext.h>
#endif

class CDepDesign : public CFormView
{
protected:
	CDepDesign();           // protected constructor used by dynamic creation
	DECLARE_DYNCREATE(CDepDesign)

// Form Data
public:
	//{{AFX_DATA(CDepDesign)
	enum { IDD = IDD_DEP_DESIGN };
...
#endif // !defined(AFX_DEPDESIGN_H__66D61723_6E51_11D4_8FC7_0008C7636E27__INCLUDED_)
