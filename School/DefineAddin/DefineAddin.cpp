// DefineAddin.cpp : Defines the initialization routines for the DLL.
//

#include "stdafx.h"
#include <initguid.h>
#include "DefineAddin.h"
#include "DSAddIn.h"
#include "Commands.h"
...
class CDefineAddinApp : public CWinApp
{
public:
	CDefineAddinApp();
...
// Overrides
	...
	//{{AFX_VIRTUAL(CDefineAddinApp)
	public:
	virtual BOOL InitInstance();
	virtual int ExitInstance();
	//}}AFX_VIRTUAL

	//{{AFX_MSG(CDefineAddinApp)
...
BEGIN_MESSAGE_MAP(CDefineAddinApp, CWinApp)
	//{{AFX_MSG_MAP(CDefineAddinApp)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CDefineAddinApp object

CDefineAddinApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CDefineAddinApp construction

CDefineAddinApp::CDefineAddinApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// CDefineAddinApp initialization

BOOL CDefineAddinApp::InitInstance()
{
	_Module.Init(ObjectMap, m_hInstance);
	return CWinApp::InitInstance();
}

int CDefineAddinApp::ExitInstance()
{
	_Module.Term();
...
STDAPI DllRegisterServer(void)
{
	...
	if (lRes == ERROR_SUCCESS)
	{
		...
		if (lRes == ERROR_SUCCESS)
		{
			...
			strDescription.LoadString(IDS_DEFINEADDIN_DESCRIPTION);
