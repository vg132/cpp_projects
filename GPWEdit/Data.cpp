...
void Data::SaveData(CString file)
//Export data to gsf
{
CFile f;
...
void Data::LoadData(CString file)
...
CString Data::ConvertTeam(int index)
{
...
CString Data::ConvertCountry(int index)
{
