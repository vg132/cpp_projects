// DepMechanics.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CDepMechanics, CFormView)

CDepMechanics::CDepMechanics()
	: CFormView(CDepMechanics::IDD)
{
	//{{AFX_DATA_INIT(CDepMechanics)
	m_Morale = 0;
...
void CDepMechanics::DoDataExchange(CDataExchange* pDX)
{
	CFormView::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDepMechanics)
...
BEGIN_MESSAGE_MAP(CDepMechanics, CFormView)
	//{{AFX_MSG_MAP(CDepMechanics)
		// NOTE - the ClassWizard will add and remove mapping macros here.
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CDepMechanics diagnostics

#ifdef _DEBUG
void CDepMechanics::AssertValid() const
{
	CFormView::AssertValid();
}

void CDepMechanics::Dump(CDumpContext& dc) const
{
	CFormView::Dump(dc);
}
#endif //_DEBUG
...
/////////////////////////////////////////////////////////////////////////////
// CDepMechanics message handlers

void CDepMechanics::Load(int id, CString file)
{
CFile f;
	...
	f.Seek(10312+(id*7824),CFile::begin);
...
void CDepMechanics::OnInitialUpdate() 
{
...
void CDepMechanics::Save(CString file)
{
CFile f;
	...
	f.Seek(10312+(m_Id*7824),CFile::begin);
